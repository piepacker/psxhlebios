...
static uint32_t& t8 = (GPR_ARRAY[16]);
static uint32_t& t9 = (GPR_ARRAY[17]);
static uint32_t& s0 = (GPR_ARRAY[18]);
static uint32_t& s1 = (GPR_ARRAY[19]);
static uint32_t& s2 = (GPR_ARRAY[20]);
static uint32_t& s3 = (GPR_ARRAY[21]);
static uint32_t& s4 = (GPR_ARRAY[22]);
static uint32_t& s5 = (GPR_ARRAY[23]);
static uint32_t& s6 = (GPR_ARRAY[24]);
static uint32_t& s7 = (GPR_ARRAY[25]);
